# Microsoft Developer Studio Project File - Name="TextFmt" - Package Owner=<4>
...
# Name "TextFmt - Win32 Release"
# Name "TextFmt - Win32 Debug"
# Name "TextFmt - Win32 Unicode Release"
# Name "TextFmt - Win32 Unicode Debug"
...
"TextFmt.tlb" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"TextFmt.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"TextFmt_i.c" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
# End Custom Build
