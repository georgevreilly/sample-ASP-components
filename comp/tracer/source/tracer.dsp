...
# Name "Tracer - Win32 Release MinSize"
# Name "Tracer - Win32 Release MinDependency"
# Name "Tracer - Win32 Unicode Release MinSize"
# Name "Tracer - Win32 Unicode Release MinDependency"
...
".\Tracer.tlb" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

".\Tracer.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

".\Tracer_i.c" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
# End Custom Build
