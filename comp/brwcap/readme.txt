...
The BrowserCap Component is an Active Server Pages component that provides
capabilities about browsers that are connected to your server.
...
The following directions are to help you register the component for use:
 ...
 2. Type the following:
	cd \InetPub\ASPSamp\Components\BrwCap\DLL\i386
 3. Type:
	regsvr32 BrwCap.dll
...
The following directions are to help you test the registered component:
 1. Use the Windows Explorer to copy all of the Sample files except
    global.asa from \InetPub\ASPSamp\Components\BrowserCap\Samples
 ...
 3. In your browser, open http://localhost/ASPSamp/Components/BrowserCap/Samples/BrowsCap.asp
...
.\Samples
 ...
 BrwCap.asp      Demonstrates the use of the BrowserCap object

.\dll\i386
 BrowsCap.dll		The BrowserCap binary
