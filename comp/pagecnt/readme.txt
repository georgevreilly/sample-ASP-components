...
To use the Page Counter, create an Application scope instance of a
page counter in your global.asa.  Then on any page you want to count
hits for, simply call the PageHit method. If you want to output the current
number of hits for this page, call the Hits method for this object.
If you provide valid PATH_INFO information to Hits, it will return the
current count for the specified page.  If you don't provide any PATH_INFO,
Hits will return the count for the current page.  In a similar manner,
you may call the Reset method to reset a page's count to zero.
...
Developer Studio, using the PgCnt.dsp project.
