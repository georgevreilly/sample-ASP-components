...
/* Object interface: IPgCntObj, ver. 0.0,
   GUID={0x4B0BAE82,0x567A,0x11D0,{0x96,0x07,0x44,0x45,0x53,0x54,0x00,0x00}} */
...
NdrStubInitialize(
    ...
    RpcTryFinally
        ...
        NdrInterfacePointerUnmarshall( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                       (unsigned char __RPC_FAR * __RPC_FAR *)&piUnk,
                                       (PFORMAT_STRING) &__MIDL_TypeFormatString.Format[0],
                                       (unsigned char)0 );
        
        
        *_pdwStubPhase = STUB_CALL_SERVER;
        _RetVal = (((IPgCntObj *) ((CStdStubBuffer *)This)->pvServerObject)->lpVtbl) -> OnStartPage((IPgCntObj *) ((CStdStubBuffer *)This)->pvServerObject,piUnk);
...
NdrStubInitialize(
    ...
    RpcTryFinally
        ...
        *_pdwStubPhase = STUB_CALL_SERVER;
        _RetVal = (((IPgCntObj *) ((CStdStubBuffer *)This)->pvServerObject)->lpVtbl) -> OnEndPage((IPgCntObj *) ((CStdStubBuffer *)This)->pvServerObject);
    ...
    /* [retval][out] */ LONG __RPC_FAR *plNumHits)
{
    ...
    RpcTryExcept
        ...
        RpcTryFinally
            ...
            *plNumHits = *(( LONG __RPC_FAR * )_StubMsg.Buffer)++;
    ...
    DWORD *_pdwStubPhase)
{
    ...
    HRESULT _RetVal;
    MIDL_STUB_MESSAGE _StubMsg;
    void __RPC_FAR *_p_bstrURL;
    BSTR bstrURL;
    LONG __RPC_FAR *plNumHits;
...
NdrStubInitialize(
    ...
    RpcTryFinally
        ...
        NdrUserMarshalUnmarshall( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                  (unsigned char __RPC_FAR * __RPC_FAR *)&_p_bstrURL,
                                  (PFORMAT_STRING) &__MIDL_TypeFormatString.Format[42],
                                  (unsigned char)0 );
        ...
        *_pdwStubPhase = STUB_CALL_SERVER;
        _RetVal = (((IPgCntObj *) ((CStdStubBuffer *)This)->pvServerObject)->lpVtbl) -> Hits(
        (IPgCntObj *) ((CStdStubBuffer *)This)->pvServerObject,
        bstrURL,
        plNumHits);
        ...
        *_pdwStubPhase = STUB_MARSHAL;
        ...
        NdrStubGetBuffer(This, _pRpcChannelBuffer, &_StubMsg);
        *(( LONG __RPC_FAR * )_StubMsg.Buffer)++ = *plNumHits;
...
NdrStubInitialize(
    ...
    RpcTryFinally
        ...
        *_pdwStubPhase = STUB_CALL_SERVER;
        _RetVal = (((IPgCntObj *) ((CStdStubBuffer *)This)->pvServerObject)->lpVtbl) -> Reset((IPgCntObj *) ((CStdStubBuffer *)This)->pvServerObject,bstrURL);
...
CINTERFACE_PROXY_VTABLE(11) _IPgCntObjProxyVtbl = 
{
    &IID_IPgCntObj,
    ...
    IPgCntObj_OnStartPage_Proxy ,
    IPgCntObj_OnEndPage_Proxy ,
    IPgCntObj_Hits_Proxy ,
    IPgCntObj_Reset_Proxy
};


static const PRPC_STUB_FUNCTION IPgCntObj_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    IPgCntObj_OnStartPage_Stub,
    IPgCntObj_OnEndPage_Stub,
    IPgCntObj_Hits_Stub,
    IPgCntObj_Reset_Stub
};

CInterfaceStubVtbl _IPgCntObjStubVtbl =
{
    &IID_IPgCntObj,
    0,
    11,
...
/*  8 */	
			...
			0x2,		/* Alpha Stack size = 2 */
#endif
/* 10 */	NdrFcShort( 0x2a ),	/* Type Offset=42 */
/* 12 */	
			0x51,		/* FC_OUT_PARAM */
#ifndef _ALPHA_
			0x1,		/* x86, MIPS & PPC Stack size = 1 */
...
/* 60 */	NdrFcShort( 0x4 ),	/* 4 */
/* 62 */	NdrFcShort( 0x0 ),	/* 0 */
/* 64 */	NdrFcShort( 0xffffffd2 ),	/* Offset= -46 (18) */

			0x0
        }
    };

const CInterfaceProxyVtbl * _PgCnt_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IPgCntObjProxyVtbl,
    0
};

const CInterfaceStubVtbl * _PgCnt_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IPgCntObjStubVtbl,
    0
};

PCInterfaceName const _PgCnt_InterfaceNamesList[] = 
{
    "IPgCntObj",
    0
};

const IID *  _PgCnt_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _PgCnt_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _PgCnt, pIID, n)

int __stdcall _PgCnt_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_PgCnt_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo PgCnt_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _PgCnt_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _PgCnt_StubVtblList,
    (const PCInterfaceName * ) & _PgCnt_InterfaceNamesList,
    (const IID ** ) & _PgCnt_BaseIIDList,
    & _PgCnt_IID_Lookup, 
    1,
    1
